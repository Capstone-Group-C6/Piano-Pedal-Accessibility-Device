//
//  TiltAngleBar1PRoll.swift
//  PPAD
//
//  Created by Mr.Jos on 11/28/23.
//

import SwiftUI

struct TiltAngleBar1PRoll: View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                Rectangle()
                    ...
                    .offset(x: self.arrowOffset(for: geometry.size.width, at: selectedAngle))
            }
        }
    }
    ...
    private func arrowOffset(for totalWidth: CGFloat, at angle: Double) -> CGFloat {
